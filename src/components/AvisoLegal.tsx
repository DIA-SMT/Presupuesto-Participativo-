        ...
        <Bloque id="aviso-ia" titulo="6. Las funciones de inteligencia artificial del sitio">
          ...
          <ol className="grid gap-4">
            ...
            <FuncionIA
              ...
              queHace="Cuando presentás una idea hay un botón, «Mejorar con IA», que hace todo junto: ordena lo que escribiste para que se entienda mejor, te dice qué le falta y te avisa si ya hay una propuesta parecida en tu distrito. En qué querés proponer y en por qué hace falta no escribe por vos: parte del texto que vos cargaste y solo lo formaliza, sin agregarle datos. En quiénes se benefician, que es opcional, puede redactar un texto deduciéndolo de lo que ya contaste, y también puede sugerirte un título. Aparte, sobre lo que querés proponer, te ofrece una lista de detalles de obra que el municipio suele pedir (el tipo de piso, la iluminación, un cerco), cada uno con una explicación de para qué sirve, para que elijas cuáles agregar."
              limite="Nunca completa el formulario solo: el texto aparece aparte y se carga únicamente si apretás «usar este texto», y después lo podés editar. Los detalles de obra son casillas: ninguno entra a tu propuesta si no lo tildás vos, y la explicación de cada uno es para que decidas, no se escribe en tu propuesta. Es una sugerencia y nada más: podés ignorarla, y lo que se envía es siempre lo que vos elegís. No evalúa tu propuesta, no la puntúa y no influye en su suerte."
            />
            <FuncionIA
