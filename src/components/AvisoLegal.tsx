        ...
        <Bloque id="aviso-ia" titulo="6. Las funciones de inteligencia artificial del sitio">
          ...
          <ol className="grid gap-4">
            ...
            <FuncionIA
              ...
              queHace="Cuando presentás una idea, puede sugerirte una forma más clara de escribirla a partir de lo que vos escribiste, sin agregar datos nuevos. También puede avisarte si ya hay una propuesta parecida."
              limite="Es una sugerencia y nada más: podés ignorarla, y el texto que se envía es siempre el que vos elegís. No evalúa tu propuesta, no la puntúa y no influye en su suerte."
            />
            <FuncionIA
